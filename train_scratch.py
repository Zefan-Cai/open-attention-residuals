...
def parse_args():
    ...
    p.add_argument("--mode", default="baseline", choices=["baseline", "block", "full", "delta", "delta_block", "delta_v", "first_layer", "pre_gated"],
                   help="baseline, block, full, delta, delta_block, delta_v (V-stream decoupled), first_layer, pre_gated")
...
def main():
    ...
    find_unused = args.mode in ("delta", "delta_block", "delta_v", "first_layer", "pre_gated") or args.gate_type != "bias"
