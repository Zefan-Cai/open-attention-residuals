...
from modeling_qwen3_attnres import Qwen3AttnResForCausalLM, Qwen3AttnResConfig
...
def parse_args():
    ...
    p.add_argument("--mode", required=True, choices=["baseline", "block", "full", "delta", "delta_block", "delta_v", "first_layer", "pre_gated"])
